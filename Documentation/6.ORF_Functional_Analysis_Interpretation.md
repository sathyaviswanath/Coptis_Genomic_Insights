...
## Data Validation 
 ...
 - To validate the functional annotation results, the cleaned eggNOG-mapper table was re‑analysed in Python using cleaned_annotation.tsv as input. 

 - The distribution of annotations was consistent across independent summaries, with COG category S (function unknown) being most frequent (523 ORFs), followed by categories L (replication, recombination and repair; 411 ORFs) and E (amino acid transport and metabolism; 138 ORFs). 

 - Likewise, the most abundant GO terms were generic cellular and biological process terms (for example GO:0005575, GO:0005623, GO:0008150) and KEGG pathways such as ko01100/map01100 (metabolic pathways) and ko00190/map00190 (oxidative phosphorylation) were repeatedly recovered as top hits together with Pfam domains typical of mobile genetic elements (RVT_1, RVT_3, Retrotrans_gag, zf-RVT)
